...
const MoviePage : React.FunctionComponent = () => {
    ...
    const gttMedium = useMediaQuery('(min-width:960px)');

    return (
        <div className={(gttMedium ? "moviePageHorizontal" : "moviePageVertical")}>
            {showFilters &&
                <Box className={(gttMedium ? "filterContainerHorizontal" : "filterContainerVertical")}>
